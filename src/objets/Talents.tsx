...
export function getTalent(talent: Talents): Talent {
    switch (talent) {
        ...
        case Talents.TakeControl:
            return {
                ...
                description: "Vous savez comment forcer autrui à faire ce que vous voulez, et vous n'avez aucun scrupule à employer ce talent. Vous pouvez faire vos tests de MANIPULATION avec votre ESPRIT plutôt que votre EMPATHIE."
            } as Talent
        case Talents.Cunning:
            return {
                name: "Ruse",
                description: "Si la compagnie vous a appris quelque chose, c'est bien de rester à l'affût de tout ce qui vous per- met d'avoir l'avantage. Vous pouvez forcer deux fois (au lieu d'une comme n'importe qui d'autre) tout test de compétence basé sur l'ESPRIT. Chaque test forcé augmente de 1 votre NIVEAU DE STRESS."
            } as Talent
        case Talents.Dodge:
            return {
                name: "Esquive",
        ...
        case Talents.Nimble:
            return {
                name: "Vif",
                description: "Vous passez votre temps à jouer ? Peut-être aux yeux des autres, mais vous ne vous y trompez pas: tous ces « divertissements » ont aiguise vos réflexes. Vous pouvez forcer deux fois (au lieu d'une comme n'importe qui d'autre) tout test de compétence basé sur l'AGILITE. Chaque test forcé augmente de 1 votre NIVEAU DE STRESS."
            } as Talent
        case Talents.Banter:
            return {
                name: "Déconnade",
        ...
        case Talents.PastTheLimit:
            return {
                ...
                description: "C'est dans les moments difficiles qu'on reconnait les vrais durs, et le plus dur, c'est vous. Vous pouvez forcer deux fois (au lieu d'une comme n'importe qui d'autre) tout test de compétence basé sur la FORCE. Chaque test forcé augmente de 1 votre NIVEAU DE STRESS."
            } as Talent
        case Talents.OverKill:
            return {
                name: "Folie meurtrière",
        ...
        case Talents.Influence:
            return {
                name: "Influence",
                description: "Votre statut s'accompagne de certains privilèges, dont celui de se faire obéir. Vous pouvez forcer deux fois (au lieu d'une comme n'importe qui d'autre) tout est de compétence basé sur l'EMPATHIE. Chaque test forcé augmente de 1 votre NIVEAU DE STRESS."
            } as Talent
